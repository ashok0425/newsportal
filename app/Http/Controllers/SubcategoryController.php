...
class SubcategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'subcategory_en'=>'required|max:225',
            'subcategory_np'=>'required|max:225',
        ...
        $subcategory->subcategory_np=$request->subcategory_np;
$subcategory->save();
$notification=array(
    'message'=>"Subtegory added sucessfully",
...
return redirect()->back()->with($notification);
    ...
    public function update(Request $request, subcategory $subcategory,$id)
    {
        ...
        $sub->subcategory_np=$request->subcategory_np;
        $sub->save();
        $notification=array(
