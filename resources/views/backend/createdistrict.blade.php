    ...
    <div class="card-body">
        ...
        @csrf
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="District English" name="district_en">
            @error('district_en')
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control"  placeholder="District Nepali" name="district_np">
            @error('district_np')
            <span class="text-danger"> {{$message}}</span>  
           @enderror
          </div>
