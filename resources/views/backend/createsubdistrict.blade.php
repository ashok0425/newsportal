...
@section('main-content')
    ...
    <div class="card-body">
        <p class="card-description font-weight-bold">Create New Subdistrict</p>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control"  placeholder="Subdistrict Nepali" name="subdistrict_np">
