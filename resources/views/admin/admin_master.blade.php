  ...
  $.ajax({
    ...
    success:function(data){
     ...
     $.each(data,function(key,value){
      $("#subcategory").append('<option value="'+value.id+'">'+value.subcategory_en+'&nbsp;|&nbsp;'+value.subcategory_np +'</option>');
...
if(cat_id){
  $.ajax({
    ...
    success:function(data){
     ...
     $.each(data,function(key,value){
      $("#subdistrict").append('<option value="'+value.id+'">'+value.district_en+'&nbsp;|&nbsp;'+value.district_np +'</option>');
