<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      @php
          $table=DB::table('websiteseetings')->first();
      @endphp
...
@if(Auth::user()->setting==1)
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="setting">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('admin.social.edit')}}"> Social Setting</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('admin.seo.edit')}}">Seo Setting </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{route('admin.livetv.edit')}}">LiveTV Setting </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('admin.notice.edit')}}"> Notice Setting </a></li>
          </ul>
        </div>
      </li>
      @else
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="gallery">
          ...
          <li class="nav-item"> <a class="nav-link" href="{{route('admin.videogallery')}}">Video Gallery </a></li>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="websitesetting">
          ...
          <li class="nav-item"> <a class="nav-link" href="{{route('admin.website')}}">Update setting </a></li>
